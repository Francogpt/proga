...
data = pd.read_csv("weekly_stocks.csv",
...
#data_3Months.plot(kind="bar", ylabel="price") #grafica de barras
#data_3Months.plot(kind="bar", stacked=True, ylabel="price") #grafica de barras horizontal
...
data_3Months.MSFT.plot(kind="pie", figsize=(14, 7), autopct="%.f")


plt.show() # se necesita para que se visualize la grafica
